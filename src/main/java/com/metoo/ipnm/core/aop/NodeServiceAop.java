...
public class NodeServiceAop {
    ...
    @Around("execution(* com.metoo.ipnm.core.manager.integrated.node.TopoNodeManagerAction.addGatherNode(..)) || execution(* com.metoo.ipnm.core.manager.integrated.node.TopoNodeManagerAction.upload(..))")
    ...
    @Around("execution(* com.metoo.ipnm.core.manager.integrated.policy.TopoPolicyIntegrateController.ruleListSearch(..))" + " || execution(* com.metoo.ipnm.core.manager.integrated.policy.TopoPolicyIntegrateController.objectList(..))")
